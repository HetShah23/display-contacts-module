            ...
            <ul className="nav-links ">
                <li className={(activeLink === "/")? "active":""}>
                    ...
                    <ul className="sub-menu blank">
                        <li><a className="link_name" href="index.php">Send SMS</a></li>
                    </ul>
                </li>

                <li className={toggleMenu?"showMenu active":""} 
                ...
                >
                    <div className="iocn-link arrow">
                        ...
                        <img src="assets/img/Arrow-dwon.png" className="droarr img-fluid " alt=" "/>

                    </div>
                    <ul className="sub-menu ">
                        <li><a className="link_name " href="#">Delivry Report</a></li>
                        <li><a href="/sent-sms" className={(activeLink === "/sent-sms")? "link_nameactiv color-blue":"link_nameactiv"}>Sent SMS</a></li>
                        <li><a href="/sms-summary" className={(activeLink === "/sms-summary")? "link_nameactiv color-blue":"link_nameactiv"}>SMS Summary</a></li>
                    </ul>
                </li>
                ...
                <li className={(activeLink === "/contacts")? "active":""}>
                    ...
                    <ul className="sub-menu blank ">
                        <li><a className="link_name " href="contacts.php">Contacts</a></li>
                    </ul>
                </li>
                ...
                <li className={(activeLink === "/templates")? "active":""}>
                    ...
                    <ul className="sub-menu blank ">
                        <li><a className="link_name " href="# ">Templates</a></li>
                    </ul>
                </li>
                ...
                <li className={(activeLink === "/dlt-headers")? "active":""}>
                    ...
                    <ul className="sub-menu blank ">
                        <li><a className="link_name " href="# ">DLT & Header</a></li>
                    </ul>
                </li>
                ...
                <li className={(activeLink === "/api")? "active":""}>
                    ...
                    <ul className="sub-menu blank ">
                        <li><a className="link_name " href="# ">API</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <div className="profile-details d-flex align-items-center ">
                        <a href="/update-profile" className="profile_name ">Manage Profile</a>
